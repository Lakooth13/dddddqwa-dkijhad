...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			SliderBackground = Color3.fromRGB(66, 20, 92),
			SliderProgress = Color3.fromRGB(66, 20, 92),
			SliderStroke = Color3.fromRGB(66, 20, 92),

			ToggleBackground = Color3.fromRGB(25,25,25),
			ToggleEnabled = Color3.fromRGB(66, 20, 92),
